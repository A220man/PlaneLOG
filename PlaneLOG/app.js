...
const LIVERIES = [
  ...
  {id:45,airline:'Malaysia Airlines',tail:'9M-MNA',type:'Airbus A380',era:'2010s',livery:'Current',colors:['#C8102E','#003B7A','#FFFFFF'],tags:['retired','superjumbo','rare'],notes:'Malaysia Airlines flew six Airbus A380s — 9M-MNA was the first delivered, in 2012 — wearing the blue-wave livery with the kite tail. The whole fleet was retired by 2022, making this a historical catch.',sightings:[]},
  {id:46,airline:'Air India',tail:'VT-ANP',icao24:'800736',type:'Boeing 787-8',era:'2010s',livery:'Konark sun (previous)',colors:['#D31247','#FF6A13','#FFFFFF'],tags:['dreamliner'],notes:'Air India Boeing 787-8 VT-ANP in the previous (2007–2023) livery — the red "Konark sun" chakra and flying-swan emblem on the tail — being phased out as the Tata-era fleet is repainted.',sightings:[]},
  ...
  {id:51,airline:'Aeroméxico',tail:'XA-ADL',icao24:'0D09D0',type:'Boeing 787-9',era:'2010s',livery:'Quetzalcóatl',colors:['#0B2B5B','#FFFFFF','#E40521'],tags:['special','dreamliner'],notes:'Aeroméxico Boeing 787-9 XA-ADL in the elaborate "Quetzalcóatl" special livery — a blue-and-white feathered-serpent design wrapping the fuselage, introduced in 2016 to showcase Mexican art and culture.',sightings:[]},
  ...
  {id:66,airline:'Icelandair',tail:'TF-FIP',type:'Boeing 757-200',era:'2010s',livery:'Current',colors:['#0A2240','#00B5E2','#FFFFFF'],tags:['current'],notes:'Icelandair, a longtime 757 operator, in the dark-blue livery with the aurora tail, suited to its North Atlantic network.',sightings:[]},
  ...
  {id:72,airline:'Royal Air Maroc',tail:'CN-RGV',icao24:'02012C',type:'Boeing 737-800',era:'2010s',livery:'60 Years',colors:['#C8102E','#0A7D4B','#FFFFFF'],tags:['special'],notes:'Royal Air Maroc Boeing 737-800 CN-RGV in the colourful "60 Years" anniversary livery — a multi-colour confetti/dot motif marking the Moroccan flag carrier\'s 60th anniversary (founded 1957).',sightings:[]},
  ...
  {id:208,airline:'Alaska Airlines',tail:'N932AK',icao24:'ACED21',type:'Boeing 737 MAX 9',era:'2020s',livery:'West Coast Wonders (Orca)',colors:['#01426A','#00467F','#76858F'],tags:['special'],notes:'Alaska Airlines Boeing 737-9 MAX N932AK in the blue full-body "West Coast Wonders" (Orca) special livery — three orcas along the fuselage and a breaching orca on the tail — unveiled in 2022 to spotlight the airline\'s environmental commitment.',sightings:[]},
  ...
  {id:338,airline:'KLM',tail:'PH-BKA',icao24:'485B42',type:'Boeing 787-10',era:'2010s',livery:'100 Years',colors:['#00A1DE','#FFFFFF','#003082'],tags:['special','dreamliner'],notes:'KLM Boeing 787-10 PH-BKA, the airline\'s first 787-10 ("Orange Blossom"), wearing the "100 Years" centenary logo applied for KLM\'s 2019 centennial.',sightings:[]},
  ...
  {id:402,airline:'Alaska Airlines',tail:'N533AS',type:'Boeing 737-800',era:'2010s',livery:'Eskimo (current)',colors:['#01426A','#00467F','#76858F'],tags:['current','eskimo'],notes:'An Alaska Airlines Boeing 737-800 in the standard ‘Eskimo’ livery, with the parka-hooded Alaska Native face on the tail.',sightings:[]},
