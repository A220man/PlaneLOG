...
const LIVERIES = [
  ...
  {id:8,airline:'Pan Am',tail:'N734PA',type:'Boeing 747',era:'1970s',livery:'Globe (blue/white)',colors:['#003591','#FFFFFF','#A0B8D8'],tags:['historic','globe','defunct'],notes:'Pan Am\'s iconic blue-globe livery on a Boeing 747-121 — the type that opened the Jumbo Jet age for the airline. Pan Am was the 747\'s launch customer, flying its first commercial service in January 1970.',sightings:[]},
  // ── More airliners ──
  ...
  {id:20,airline:'Air France',tail:'F-HPJA',type:'Airbus A380',era:'2010s',livery:'Current',colors:['#002157','#FFFFFF','#EE2737'],tags:['current','superjumbo'],notes:'F-HPJA was Air France\'s first Airbus A380, in the carrier\'s blue, white and red livery.',sightings:[]},
  ...
  {id:30,airline:'Alaska Airlines',tail:'N559AS',type:'Boeing 737-800',era:'2010s',livery:'Eskimo (current)',colors:['#01426A','#00467F','#76858F'],tags:['current','eskimo'],notes:'Alaska Airlines\' "Eskimo" tail portrait on a Boeing 737-800.',sightings:[]},
  ...
  {id:40,airline:'Korean Air',tail:'HL7644',type:'Boeing 747-8I',era:'2010s',livery:'Current',colors:['#1B4DA1','#7AB3E0','#FFFFFF'],tags:['current','jumbo'],notes:'Korean Air\'s sky-blue livery on a Boeing 747-8 Intercontinental — among the last passenger 747s ever built.',sightings:[]},
  ...
  {id:44,airline:'Thai Airways',tail:'HS-TUD',type:'Airbus A380',era:'2010s',livery:'Royal Orchid (current)',colors:['#4B186C','#D4A017','#E5007E'],tags:['current','superjumbo'],notes:'Thai Airways International in the purple-and-gold "Royal Orchid" livery on an Airbus A380.',sightings:[]},
  {id:45,airline:'Malaysia Airlines',tail:'9M-MNB',type:'Airbus A380',era:'2010s',livery:'Current',colors:['#C8102E','#003B7A','#FFFFFF'],tags:['current','superjumbo'],notes:'Malaysia Airlines in the current livery on an Airbus A380.',sightings:[]},
  ...
  {id:63,airline:'Air China',tail:'B-2485',type:'Boeing 747-8I',era:'2010s',livery:'Current (phoenix)',colors:['#C8102E','#E8B100','#FFFFFF'],tags:['current','jumbo'],notes:'Air China in the red livery with the gold phoenix logo on a Boeing 747-8 Intercontinental.',sightings:[]},
  {id:64,airline:'China Southern',tail:'B-6137',type:'Airbus A380',era:'2010s',livery:'Kapok (current)',colors:['#0066B3','#E4002B','#FFFFFF'],tags:['current','superjumbo'],notes:'China Southern Airlines, with the red kapok-flower logo, on an Airbus A380.',sightings:[]},
  ...
  {id:70,airline:'Virgin Australia',tail:'VH-VOZ',type:'Boeing 777-300ER',era:'2010s',livery:'Current',colors:['#C8102E','#5A2D81','#FFFFFF'],tags:['current','widebody'],notes:'Virgin Australia in the current livery on a Boeing 777-300ER.',sightings:[]},
  ...
  {id:208,airline:'Alaska Airlines',tail:'N932AK',type:'Boeing 737-9 MAX',era:'2020s',livery:'Eskimo (current)',colors:['#01426A','#00467F','#76858F'],tags:['current','eskimo'],notes:'Alaska Airlines\' newest narrowbody, the Boeing 737-9 MAX, with the Eskimo tail.',sightings:[]},
  ...
  {id:220,airline:'China Airlines',tail:'B-18206',type:'Boeing 747-400',era:'2000s',livery:'Plum blossom (current)',colors:['#C8102E','#E8E0CF','#1A3C6E'],tags:['jumbo','widebody'],notes:'A China Airlines Boeing 747-400 — the carrier flew passenger 747-400s well into the 2020s.',sightings:[]},
  ...
  {id:256,airline:'Korean Air',tail:'HL8348',type:'Boeing 737-8 MAX',era:'2020s',livery:'Current',colors:['#1B4DA1','#7AB3E0','#FFFFFF'],tags:['current'],notes:'A Korean Air Boeing 737-8 MAX.',sightings:[]},
